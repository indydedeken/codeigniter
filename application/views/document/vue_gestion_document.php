                ...
                <div id="liste-document" class="list-group">
                    <div role="toolbar" class="btn-toolbar">
                        ...
                        foreach($documents->result() as $item) { 
                            ...
                            ?>	
                            <a id="document_<?=$item->idGroupe?>_<?=$item->id?>" class="list-group-item" href="<?=base_url('document/afficher/'.$item->id.'/groupe/'.$item->idGroupe)?>" title="document">
                                <?=$item->titre?><br>
                        ...
                        foreach($documentsPersonnels->result() as $item) { 
                            ...
                            ?>	
                            <a id="document_0_<?=$item->id?>" class="list-group-item" href="<?=base_url('document/afficher/'.$item->id.'/groupe/'.$item->idGroupe)?>" title="document">
